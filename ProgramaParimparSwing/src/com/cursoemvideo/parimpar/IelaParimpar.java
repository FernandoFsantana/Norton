 ...
 * @author fernando
 */
public class IelaParimpar extends javax.swing.JFrame {

    /**
     * Creates new form IelaParimpar
     */
    public IelaParimpar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IelaParimpar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IelaParimpar().setVisible(true);
            }
        });
    }
